                                        ...
                                        <div class="modal fade bd-isi-modal-lg<?=$id_rak;?>" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    $SQLisi = "SELECT * FROM tampung_rakbuku
                                                    JOIN bukusaya ON tampung_rakbuku.noseri_buku = bukusaya.noseri_buku WHERE id_rak = '$data[id_rak]'";
                                                    ...
                                                    <div class="col-4 mr-3">
                                                        <div class="card">
                                                            ...
                                                            <p class="card-text"><?=$judul;?><?=$filerak;?></p>
